          ...
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center relative overflow-hidden">
                {process.env.NEXT_PUBLIC_MJPEG_STREAM_URL ? (
                  <>
                    <img
                      src={process.env.NEXT_PUBLIC_MJPEG_STREAM_URL || "/placeholder.svg"}
                      alt="실시간 카메라 피드"
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 hidden items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-400 text-lg">카메라 연결 실패</p>
                        <p className="text-gray-500 text-sm mt-2">스트림을 불러올 수 없습니다</p>
                      </div>
                    </div>
                  </>
                ) : (
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 text-sm mt-2">MJPEG 스트림 URL을 설정해주세요</p>
                    </div>
                  </div>
                )}
